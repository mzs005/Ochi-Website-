  ...
  return (
    <div className='flex gap-5 w-full h-screen bg-zinc-900 p-20 font-["Founders_Grotesk_X-Condensed"]'>
        <div className=' flex flex-col justify-between w-1/2 h-full'>
           ...
           <h1 className='text-[6vw] uppercase -mb-10 font-semibold  leading-normal'>Eye_</h1>
            <h1 className='text-[6vw] uppercase -mb-10 font-semibold  leading-normal'>Opening</h1>
           </div>
        ...
        <div className='w-1/2'>
        <h1 className='text-[5vw] uppercase -mb-10 font-semibold  leading-normal'>Presentations</h1>
        <div className='mt-10'>
            {["Instagram","Behance","Facebook","Linkedin"].map((items,index)=>{
                return <a href="#" className='font-["Neue_Montreal"] block text-2xl font-light underline'>{items}</a>
            }
        )}
        <div className='link-2 mt-16'>
        {["202-1965 W 4th Ave","Vancouver, Canada","30 Chukarina St","Lviv, Ukraine"].map((items,index)=>{
                return <a href="#" className='font-["Neue_Montreal"] block text-2xl font-light underline'>{items}</a>
            }
            )}
            <div className='link-2 mt-16'>
        {["M Zeeshan Portfolio"].map((items,index)=>{
                return <a href="#" className='font-["Neue_Montreal"] block text-2xl font-light'>{items}</a>
            }
            )}
            </div>
        </div>
